...
<div class="griddeboerderij">
  ...
  <div class="deboerderij deboerderij5">
    <h2>Schillen</h2>
    <p>
    Het schillen van de asperges hoeft u niet zelf meer te doen.
    Dankzij onze schilmachine kunt u onze asperges vers en goed geschild meenemen.
    Zo kunt u heel snel een gezonde maaltijd op tafel zetten.
    Wilt u de asperges een paar dagen geschild bewaren dan kunt u ze ook laten verpakken in bakjes met een speciale folie.
    In de koelkast blijven ze nog één week houdbaar.
    Voor degenen die een voorraad in de diepvries willen aanleggen zijn deze bakjes ook erg handig.
    Wanneer u asperges uit de diepvries wilt gaan gebruiken wel eerst het water koken,
    daarna de bevroren asperges in het kokende water doen.
  ...
  <div class="deboerderij deboerderij12">
    ...
    Asperges zijn vocht afdrijvend en daarmee goed voor de nieren.
    Van celdeling tot immuunsysteem,
